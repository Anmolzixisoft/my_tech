...
const { login, verifyByOtp, setPass, sentOtp, addsuperadmin, adminLogin, getsuperadmin, activeDiactiveUser, updatesuperadmin, deletesuperadmin } = require('../controllers/login.controller');
...
loginRouter.post('/updatesuperadmin', updatesuperadmin)
loginRouter.post('/deletesuperadmin', deletesuperadmin)
