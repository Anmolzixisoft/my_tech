...
const { productAdd, getProduct, deleteProduct, addDetailslipment, editproduct, getProductbyid, delivered_status_change } = require("../controllers/product.controller")
...
productRouter.post('/addDetailsproduct', addDetailslipment)
